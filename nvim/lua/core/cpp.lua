...
vim.api.nvim_create_user_command('CMake', 'term ' .. savePwd ..'; ' .. cdBuildDir .. ' && ' .. cmakeCmd ..' && ' .. linkCompileCommands .. ' && ' .. makeCmd, {})

-- clean project
vim.api.nvim_create_user_command('CleanBuild', '!rm -rf "' .. buildFolder .. '"', {})

-- run tests
vim.api.nvim_create_user_command('RunTest', 'term ctest --test-dir "' .. buildFolder .. '"', {})
